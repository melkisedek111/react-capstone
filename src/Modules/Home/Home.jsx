			...
			<BackgroundContainer>
				<MainContainer>
					...
					>
						<ChipContainer>
							<h5>NEW</h5>
							<h6>Stay connected to get more promotion about real estate</h6>
						</ChipContainer>
			...
			<FeaturedInformation>
				<InfoOneContainer>
					<div data-aos="fade-left">
						<h1>
							We provide houses, apartments, and soho with modern designs and
							the best facilities for you.
						</h1>
						<Button variant="contained" endIcon={<DoubleArrowRoundedIcon />}>
							About Us
						</Button>
					</div>
					<div data-aos="fade-right">
						...
						<h6>
							...
							lacus malesuada imperdiet id ac urna. Morbi ac libero consequat
							ipsum consequat volutpat. Duis finibus ex quam, et malesuada sem
							gravida ac.
						</h6>
						<h6>
							...
							turpis egestas. Integer ultrices sem non porta placerat.
						</h6>
					</div>
				</InfoOneContainer>
				<InformationCardContainer>
					...
					<Grid item xs={12} md={6} data-aos="fade-left">
						<FeaturedFacilitiesDescription>
							...
							<p>
								...
								faucibus. Quisque velit dui, vehicula sed orci ac, elementum
								lacinia velit.
							</p>
							<IconWithDetailsContainer>
			...
			<LeadersSection>
				<LeadersHeading>
					<div>
						...
						<p>
							Real estate agent is a person who represents sellers or buyers of
						</p>
						<p>
							...
							<AOSContainer data-aos="fade-right" data-aos-duration="1000">
								<ProjectLocationChip>
									...
									<Card>
										<CardContent>
											<h3>The Atherton</h3>
											<h6>Dr. A. Santos Ave., Parañaque City | Penthouse</h6>
											<Grid container>
								...
								<ProjectLocationChip>
									...
									<Card>
										<CardContent>
											<h3>The Crestmont</h3>
											<h6>
												Panay Ave., South Triangle, Quezon City | Double Height
											</h6>
											<Grid container>
												<Grid item xs={12} md={4}>
													<IconContainer>
			...
			<CompanyPartnersSection>
				<CompanyPartnerContainer>
					<Grid container>
						...
						<Grid item sx={12} md={6}>
							<h5>
								Vestibulum ultricies semper nibh nec scelerisque. Quisque scele
								condimentum lacus non blandit. Praesent euismod lorem eternal
								tempor. Mauris sem ante, elementum.
							</h5>
						</Grid>
