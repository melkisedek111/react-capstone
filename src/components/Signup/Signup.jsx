...
import { increment } from "../../redux/user/user.reducer";
...
const Signup = () => {
	...
	const handleValidation = () => {
		...
		for (const field in fields) {
			...
			else if (field === "username" || field === "confirmPassword" || field === "password") {
				if(value.match(usernameValidation)){
					errors[field] = `Your ${label} must not contain white spaces.`;
				}
			}
	...
	const handleFormSubmit = () => {
		...
		dispatch(increment({ id: 123, title: 'Hello World' }))
		console.log(2222)
